...
* Be part of hands-on workshops that reimagine newsroom tech, teamwork, leadership, community, and journalism itself&mdash;not panels where you sit back and listen, but sessions where you participate and learn.
...
* **We experiment in the open**&mdash;by sharing our work and processes, we do the transformative work our organizations need to better connect with and inform our communities.
...
[Ticket prices start at {{ page.price_base }}](/attendees/#tickets), plus ticketing fees. We'll also offer a limited number of need-based, [free scholarship tickets as well as {{ page.price_stipend }} travel or caregiving stipends](/scholarships).
