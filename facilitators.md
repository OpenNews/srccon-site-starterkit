...
#### What is a facilitator and what do they do? {#facilitators}
...
- **Scope:** Broad topics need some boundaries, or conversations won't go anywhere. Over-programming a session with too many activities can make it impossible to get through everything you have planned, but a session that's underdesigned can easily turn into a conversation between a handful of the loudest people.
