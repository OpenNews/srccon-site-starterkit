...
_Thinking about proposing a session for {{ page.event_name }}? We'll have your back throughout the process. Here are some answers to questions that might be on your mind right now, and if you're curious about anything else, [please let us know](mailto:srccon@opennews.org)!_
...
- **{{ page.session_deadline }}**: Deadline to submit session proposals and stipend applications using our [call for participation form](/participation/form/)
...
#### How we review proposals {#review}
...
#### What if I _kind of_ have a session idea, but it's not fully formed yet? {#unformed}
...
#### What kind of planning support is there for session facilitators? {#support}

If your session is selected, we'll support you throughout your planning process. That starts as soon as we confirm your session for the program, when we'll share [a Facilitator Guide that should look a lot like this one](https://2025.srccon.org/facilitators/).
...
#### Is there financial support for session facilitators? Do facilitators have to purchase a ticket? {#support}
...
#### Writeups from previous SRCCONs {#prior}
...
- [SRCCON:2025](https://2025.srccon.org/schedule/)
