...
We'll keep this form open for attendees as long as space remains available.

After we review your form, we will let you know whether you are invited to attend. If so, we will send a link so you can purchase a ticket to {{ page.event_name }}, with <a href="/attendees/#tickets">prices starting at {{ page.price_base }} plus fees</a>.
...
<iframe class="airtable-embed" src="{{ page.form_link }}" onmousewheel="" width="100%" height="5155" style="background: transparent; border: 1px solid #ccc;"></iframe>
