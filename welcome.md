...
- [What's the SRCCON story?](#story)
- [When and where is SRCCON?](#when-where)
...
- [Do people do any homework before they arrive?](#homework)
- [What's the hashtag? Do you want my pictures?](#photos)
- [What happens at the opening to SRCCON?](#opening)
- [What is the COVID policy at SRCCON?](#covid)
- [Wait, why is my org not on my name tag?](#nametag)
- [What are these lanyard colors all about?](#lanyards)
- [What are the sessions like?](#sessions)
...
- [I have non-conference work to do! Help!](#work)
- [What happens in the closing to SRCCON?](#closing)
- [What happens once SRCCON is over?](#after)
- [Who makes this whole SRCCON thing happen?](#organizers)
- [I have another question, how can I find out more?](#more)
...
This year we're in {{ page.event_place}} on {{ page.event_date }} at {{ page.event_venue }}. We're so excited to be with you in person.
...
Some sessions might encourage people to do a bit of reading or look at some software before taking part&ndash;there are notes docs linked from each session on the schedule where facilitators can share anything they want you to know.

### Do you want my pictures? {#photos}

We love SRCCON photos! If you take pictures during the conference (following the guidelines below), feel free to tag us on social media (we're @opennews on various platforms, and we'll be using the hashtag #SRCCON). You can also email them right to us. We love sharing your photos when we talk about SRCCON!
...
We want everyone who comes to SRCCON to feel safe and cared for. We know that encouraging precautions like testing and masking make it possible for more members of our commuity to attend. We're seeing that it's possible to come together in a group where some people mask and others do not as long as we're all doing our best to look out for others. More info on our [health policy](/#health-policy).
...
- Every attendee is a peer. Conference badges don't flag organizations or speaker status&ndash;we're all here to learn from each other.
...
You have a bunch of options. You could certainly chat with a stranger who may be thinking exactly the same thing. You could make a(nother) cup of coffee or tea. You could check out the lobby area. You could go for a walk outside in the park in front of the building. You should use that time&ndash;as all other time at SRCCON&ndash;in the way that best meets your needs. We do our best to provide numerous options so that one of them will be what you need at the time.

Extra-long breaks mean you don't have to choose between taking care of your needs or finishing up an interesting conversation with someone else&ndash;you have plenty of time for both before you head off to your next session.
...
We understand. Given the participatory nature of SRCCON sessions, it's not a good idea to try to multi-task in the session itself. But you can find space throughout the venue for quiet work&ndash;there is a lobby area with a bunch of chairs by a fireplace, there is a wide expansive park in front of the buildings, and there's ample hallway space for huddling. We'll also have a quiet workspace set aside in the Gateway Room on the 1st floor.
